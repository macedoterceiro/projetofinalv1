            ...
            <tbody>
                <?php $__currentLoopData = $cons; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $con): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        ...
                        <td><a href="/contatos/<?php echo e($con->id); ?>/telefones" class="btn btn-sn btn-secondary">Lista de Telefones</a></td>
                        <td>
                            <a href="/contatos/editar/<?php echo e($con->id); ?>" class="btn btn-sn btn-primary">Editar Contato</a>
                            <a href="/contatos/apagar/<?php echo e($con->id); ?>" class="btn btn-sn btn-danger">Apagar Contato</a>
                            </td>
                    </tr>
